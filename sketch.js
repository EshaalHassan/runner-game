...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(50, width- 300),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(100, width-200),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(50, width-250),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(50, width-348),40, 10, 10));
